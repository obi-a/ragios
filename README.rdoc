...
Ragios can also run as a Rails Plugin. This gives you web access to your active monitors. Yeti is a sample rails app using Ragios as a Rails Plugin, still under development. Yeti will provide a Web UI for Ragios. See more on Yeti here: https://github.com/obi-a/yeti

To install Ragios as a Plugin for a Rails app:
