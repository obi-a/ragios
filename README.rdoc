...
Built-in objects are available for different forms of system monitoring. These objects run tests on the system at specified time intervals and notifies the admin when a test fails.
