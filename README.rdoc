...
Next you need to run this ruby script
...
Now open the tweet_notifier.rb script located in /ragios/lib/ragios/notifiers directory. The tweet_notifier script is shown below:
...
I will add more built-in notifiers soon. 
