...
@notification_interval is the time interval between sending notifications to system admin when a test is still in a failed state. In the above example, we have  
...
@notification_intervals could also be in seconds, minutes, hours or combined.
