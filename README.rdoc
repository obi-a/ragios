...
===Using Ruby Mixins to configure Ragios
You can simplify the /ragios/main.rb script by grouping similar attributes of your monitoring object together in Modules.
