...
- break up the app into multiple apps running on multiple processes
- new concurrent and fault tolerant design
- Use as little dependencies as possible each app runs its own Gemfile.
- Preferred target system - Rubinius
