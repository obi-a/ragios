$(function() {
    $('#add-field-button').click(function () {
        $('#new-monitor-table').append('<tr><td><span class="delete-field glyphicon glyphicon-remove" data-toggle="tooltip" data-placement="top" title="Delete field"></span></td><td><textarea class="new-monitor-field" rows="1" style="width: 100%;"></textarea></td><td ><textarea class="new-monitor-value" rows="1" style="width: 100%;"></textarea></td></tr>');
