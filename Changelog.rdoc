...
* Ability to add failure recovery code to monitors. The system supports 2 types of failure recovery code, code to be run by Ragios when the monitored system goes into a failed state, and to run when the system recovers from failure.
