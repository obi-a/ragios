...
* Notifiers now respond to a failed and resolved method call, to notify users on test failure and resolution respectively.

10-18-2013
* Changed the DSL for monitors to be more intuitive, see example below:
 {monitor: "My Website",
  url: "http://mysite.com",
  every: "5m",
...
* Datastore for Ragios is now pluggable, currently implemented with couchDB but could be easily plugged and replaced with another datastore.
