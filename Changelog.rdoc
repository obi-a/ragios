...
* Simplified the interface to the system by introducing the Ragios::System object, which means the monitoring system can by using the following easier to understand code below:
